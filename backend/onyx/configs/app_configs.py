...
# Session cookie configuration for specific domains
WEB_CONNECTOR_SESSION_COOKIE_DOMAIN = os.environ.get("WEB_CONNECTOR_SESSION_COOKIE_DOMAIN")
WEB_CONNECTOR_SESSION_COOKIE_VALUE = os.environ.get("WEB_CONNECTOR_SESSION_COOKIE_VALUE")
WEB_CONNECTOR_SESSION_COOKIE_NAME = os.environ.get("WEB_CONNECTOR_SESSION_COOKIE_NAME", "session")
